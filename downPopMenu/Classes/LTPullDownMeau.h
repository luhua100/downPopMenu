...
- (UIButton *)pullDownMenuButtonForColAtIndex:(NSInteger)index;
...
- (UIViewController *)pullDownMenuViewControllerForColAtIndex:(NSInteger)index;
...
- (CGFloat)HeightForColAtIndex:(NSInteger)index;
...
@interface YZPullDownMeau : UIView

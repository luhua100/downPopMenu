...
//
//  Created by luhua-mac on 2018/3/22.
//  Copyright © 2018年 luhua-mac. All rights reserved.
//

#import "LTPullDownMeau.h"
...
- (UIView *)coverView
{
    if (_coverView == nil) {
        ...
        // CGFloat coverH = LTScreenHeight - coverY;
        
        _coverView = [[LTCoverView alloc] initWithFrame:CGRectMake(coverX, coverY, coverW, coverH)];
...
- (void)setup
{
    ...
    _coverColor = [[UIColor blackColor]colorWithAlphaComponent:0.6];
    // 监听更新菜单标题通知
...
//    }
    ...
    if (![self.dataSource respondsToSelector:@selector(pullDownMenuButtonForColAtIndex:)]) {
...
//    }
    ...
    if (![self.dataSource respondsToSelector:@selector(pullDownMenuViewControllerForColAtIndex:)]) {
...
//    }
    ...
    if (![self.dataSource respondsToSelector:@selector(HeightForColAtIndex:)]) {
...
//    }
   ...
   // NSInteger cols = [self.dataSource numberOfColsInMenu:self];
    ...
    NSInteger cols = [self.dataSource numberOfColsInMenu];
    ...
    for (NSInteger col = 0; col < cols; col++) {
       ...
       // UIButton *menuButton = [self.dataSource pullDownMenu:self buttonForColAtIndex:col];
        ...
        UIButton *menuButton = [self.dataSource pullDownMenuButtonForColAtIndex:col];
        ...
        CGFloat height = [self.dataSource HeightForColAtIndex:col];
        ...
        UIViewController *vc = [self.dataSource pullDownMenuViewControllerForColAtIndex:col];
